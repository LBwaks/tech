! function(t) {
    ...
    var n = function(t) {
                    ...
                    return new Promise((function(r, i) {
                        ! function r(e, o, i, a) {
                            ...
                            if ("throw" !== c.type) {
                                var u = c.arg,
                                    l = u.value;
                                return l && "object" == typeof l && n.call(l, "__await") ? Promise.resolve(l.__await)
                                    .then((function(t) {
                                        r("next", t, i, a)
                                    }), (function(t) {
                                        r("throw", t, i, a)
        ...
        return d.prototype = b.constructor = v, v.constructor = d, v[c] = d.displayName = "GeneratorFunction", t.isGeneratorFunction = function(t) {
            ...
            return t.isGeneratorFunction(e) ? i : i.next()
                .then((function(t) {
    ...
    var e = "https://unicons.iconscout.com/".concat("release", "/")
    ...
    var n = function(t) {
            t.forEach((function(t) {
                fetch("".concat(e)
                    ...
                    .then((function(r) {
                        return function(t, r) {
                            for (var n = document.getElementsByClassName("".concat("uim-")
                                    .concat(t)); n.length > 0;) {
                                var o = n[0],
                                    i = document.createElement("span");
                                i.innerHTML = r, i.classList.add("uim-svg"), i.firstChild.setAttribute("width", "1em"), i.style.cssText = o.style.cssText, o.classList.contains("uim-white") && (i.style.mask = "url(".concat(e)
                                    .concat(t, ".svg)"), i.style.webkitMask = "url(".concat(e)
                                    .concat(t, ".svg)"), i.style.background = "white"), o.replaceWith(i)
                            }
                        }(t, r)
                    }))
            }))
                ...
                t[e].classList.forEach((function(t) {
                    if (t.indexOf("uim-") > -1) {
                        var e = t.toLocaleLowerCase()
                            .replace("uim-", ""); - 1 === r.indexOf(e) && r.push(e)
                    }
                }))
            }
            n(r)
